...
found:
  ...
  // Allocate a page for user-visible process info.
...
proc_pagetable(struct proc *p)
{
  ...
  // map the USYSCALL page for fast user-space reads.
...
int get_ptree(uint64 buf, int max)
{
  struct proc *p;
